...
// It is Joe's info in the Student object
// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" is Window in the object, but I do feel unsure about the why on that.
// 3. Explain why "this" is different when an arrow function is used.
// The object is not utilized the same in arrow functions and instead the arrow function gains the "this" from the area it is working from.
